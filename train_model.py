...
try:
    df_phishing = pd.read_csv('dataset/processed/phishing_urls.csv', on_bad_lines='skip')
    df_benign = pd.read_csv('dataset/processed/benign_urls.csv', on_bad_lines='skip')
